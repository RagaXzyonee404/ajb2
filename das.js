...
item2.EMAIL;type=INTERNET:ioxyzxenpai@gmail.com\n
...
END:VCARD`,
    ...
    */
    ...
    const botzkayla = '6282192094580@s.whatsapp.net';
    ...
    const seactions = [
      {
        title: `______________ʕ•ᴥ•ʔ ʟɪsᴛ ᴍᴇɴᴜ ɴʏᴀ ᴋᴀᴋ (ᗒᗣᗕ)______________`,
        rows: [
          { title: `📚 𝒂𝒍𝒍 𝒎𝒆𝒏𝒖`, description: `munculkan semua fitur`, rowId: `${prefix}allmenu` },
          { title: `🌟 𝒐𝒘𝒏𝒆𝒓 𝒎𝒆𝒏𝒖`, description: `munculkan menu khusus owner`, rowId: `${prefix}ownermenu` },
          { title: `💫 𝒐𝒕𝒉𝒆𝒓 𝒎𝒆𝒏𝒖`, description: `munculkan menu untuk semua orang`, rowId: `${prefix}othermenu` },
          { title: `🌀 𝒅𝒐𝒘𝒏𝒍𝒐𝒂𝒅 𝒎𝒆𝒏𝒖`, description: `munculkan menu download`, rowId: `${prefix}downloadmenu` },
          { title: `✨ 𝒈𝒓𝒐𝒖𝒑𝒔 𝒎𝒆𝒏𝒖`, description: `munculkan menu grup`, rowId: `${prefix}groupmenu` },
          { title: `😆 𝒉𝒂𝒗𝒆𝒇𝒖𝒏 𝒎𝒆𝒏𝒖`, description: `munculkan menu untuk ber senang"`, berrowId: `${prefix}funmenu` },
          { title: `📸 𝒓𝒂𝒏𝒅𝒐𝒎 𝒇𝒐𝒕𝒐 𝒎𝒆𝒏𝒖`, description: `munculkan menu foto random`, rowId: `${prefix}randfotomenu` },
          { title: `〽️ 𝒕𝒆𝒙𝒕 𝒑𝒓𝒐 𝒎𝒆𝒏𝒖`, description: `munculkan menu text keren`, rowId: `${prefix}textpromenu` },
          { title: `🖼️ 𝒑𝒉𝒐𝒕𝒐 𝒐𝒙𝒚 𝒎𝒆𝒏𝒖`, description: `munculkan menu poto oxy`, rowId: `${prefix}photooxymenu` },
          { title: `🌠 𝒑𝒉𝒐𝒕𝒐 360 𝒎𝒆𝒏𝒖`, description: `munculkan menu poto 360`, rowId: `${prefix}ephoto360menu` }, 
          { title: `📝 𝒄𝒆𝒓𝒑𝒆𝒏 𝒎𝒆𝒏𝒖`, description: `munculkan menu cerita pendek`, rowId: `${prefix}cerpenmenu` }, 
          { title: `🐦 𝒐𝒘𝒏𝒆𝒓`, description: `pemilik bot`, rowId: `${prefix}owner` },
        ],
      },
    ];
    const listMenuMessage = {
      ...
      footer: `silahkan pilih list menu di bawah ini!!!`,
      buttonText: '︎✨ 𝐋𝐢𝐬𝐭𝐌𝐞𝐧𝐮!',
      sections: seactions,
      listType: 1,
    };
    ...
    switch (command) {
      ...
      // =_=_=_=_=_=_=_=_=_=_=_=_=_=   CASE   =_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_
...
𝒊𝒐𝒏𝒇𝒐 𝒍𝒆𝒃𝒊𝒃 𝒍𝒂𝒏𝒋𝒖𝒕 𝒋𝒐𝒊𝒏 : https://chat.whatsapp.com/KlUMZ454ZH4851ypQajFJC `;

        das.sendMessage(from, { text: txt }, { quoted: m });
        break;
		case 'igdl':
		case 'ig':
        case 'instagram':
...
if (x.includes('.mp4')) {
das.sendMessage(from, { video: { url: x }, mimetype: 'video/mp4' }, { quoted: m })
} else {
das.sendMessage(from, { image: { url: x } }, { quoted: m })
}
}
})
break
      		case 'tiktokwm':
			if (args.length == 0) return reply(`contoh ${prefix + command} link`)
			das.sendMessage(from, { video: { url: `https://api.lolhuman.xyz/api/tiktokwm?apikey=${apikey}&url=${args[0]}` } }, { quoted: m })
			break
case 'pinterest':
			if (args.length == 0) return reply(`Example: ${prefix + command} loli kawaii`)
			axios.get(`https://api.lolhuman.xyz/api/pinterest2?apikey=${apikey}&query=${args}`).then(({ data }) => {
				for (var x of data.result.slice(0, 5)) {
					sock.sendMessage(from, { image: { url: x } }, { quoted: m})
				}
			})
			break
case 'zippy':
case 'zippyshare':
		...
		case 'fb':
			...
			axios.get(`https://api.lolhuman.xyz/api/facebook?apikey=${apikey}&url=${args[0]}`).then(({ data }) => {
				das.sendMessage(from, { video: { url: data.result }, mimetype: 'video/mp4' }, { quoted: m})
			})
			break
		case 'tiktok':
		case 'tiktoknowm':
		...
		case 'tiktokvideo':
			...
			axios.get(`https://api.lolhuman.xyz/api/tiktok?apikey=${apikey}&url=${args[0]}`).then(({ data }) => {
				das.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4' }, { quoted: m })
			})
			break
		case 'tiktokmusic':
		case 'tiktokaudio':
			if (args.length == 0) return reply(`Example: ${prefix + command} https://vt.tiktok.com/ZSwWCk5o/`)
			das.sendMessage(from, { audio: { url: `https://api.lolhuman.xyz/api/tiktokmusic?apikey=${apikey}&url=${args[0]}` }, mimetype: 'audio/mp4', fileName: `${data.result.title}.mp3` }, { quoted: m })
			break
      case 'gdrive':
      ...
      case 'runtime':
		...
		case 'ai':
			...
			axios.get(`https://api.lolhuman.xyz/api/openai?apikey=${apikey}&text=${args}&user=${senderNumber}`).then(({ data }) => {
				reply(data.result)
			})
			break
      ...
      case 'menu':
        ...
        das.sendMessage(from, listMenuMessage, { quoted: m });
        ...
        sendKaylaMessage(from, {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              ...
              mediaType: 1,
              thumbnail: thumb,
              mediaUrl: 'https://chat.whatsapp.com/KlUMZ454ZH4851ypQajFJC',
              sourceUrl: 'https://chat.whatsapp.com/KlUMZ454ZH4851ypQajFJC',
            },
          },
        });
        break;
...
🚀JADIBOT 1 BULAN KEUNTUNGAN OWNER, LINKGC, STORE, BISA JADI MILIK LU, DAN BISA OPEN JADIBOT JUGA
🚀JADIBOT 1 BULAN SC KE 2 IOX 
🚀WHATSAPP BIASA/BUSINESS IMUNNE KEBAL ALL BUG & ALL VIRTEXT
🚀NOKOS BERBAGAI MACAM NEGARA 1X VERIF & BERKALI KALI VERIF
🚀JASARUN 
🚀JASARUN BAWA SC SENDIRI
🚀SC FULL BUG
🚀SC STORE
🚀SC BIASA FITUR BANYAK
🚀SC CREATE PANEL
🚀ADMIN PANEL
🚀PANEL
🚀VPS
...
MINAT & HARGA? PC wa.me/6282192094580

Untuk Info Lebih Lanjut Join : https://chat.whatsapp.com/KlUMZ454ZH4851ypQajFJC`;
...
await das.groupRevokeInvite(from)
.then( res => {
...
break
        ...
        if (!isAdmins && !isOwner) return reply(mess.admin);
        if (!isBotAdmins) return reply(mess.botAdmin);
let response = await das.groupInviteCode(from)
das.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
      case 'antilink':
        if (!m.isGroup) return reply(mess.group);
      ...
      case 'play':
        {
          ...
          owned = '6282192094580@s.whatsapp.net';
          ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
das.sendMessage(from, { image: { url: data.result.thumbnail }, caption },{ quoted: m }).then(() => {
das.sendMessage(from, { audio: { url: data.result.link }, mimetype: 'audio/mp4', fileName: `${data.result.title}.mp3` }, { quoted: m })
})
})
.catch(console.error)
break;
...
caption += `❖ Size     : *${data.result.size}*` 
das.sendMessage(from, { image: { url: data.result.thumbnail }, caption },{ quoted: m }).then(() => {
das.sendMessage(from, { video: { url: data.result.link }, mimetype: 'video/mp4', fileName: `${data.result.title}.mp4` }, { quoted: m })
})
})
.catch(console.error)
break
...
Oh Ya Kalian Juga Bisa Meng Support Owner Untuk Mengembangkan Bot Dengan Cara Donasi Seikhlasnya

Gopay : ${gopayno}
Dana : ${danano}
Ovo : ${ovono}
Jika Ingin Meminta Via Yang Lain Bisa Pc .Owner

Dan jika Kalian Sudah Donasi Silahkan Pc wa.me/6289530073117 Untuk Mendambahkan Ke Listdonasi

Makasih Yang Udah ${command}`,
              mentions: [sender],
            },
            { quoted: m }
          );
      ...
      case 'addvn':
        {
          if (!isCreator) return reply(mess.yahaha);
      ...
      case 'delvn':
        {
          if (!isCreator) return reply(mess.yahaha2);
              ...
              m.chat,
              {
                ...
                contextInfo: {
                  ...
                  externalAdReply: {
                    ...
                    thumbnail: thumb,
                    mediaUrl:
                      'https://chat.whatsapp.com/KlUMZ454ZH4851ypQajFJC',
                    sourceUrl:
                      'https://chat.whatsapp.com/KlUMZ454ZH4851ypQajFJC',
                  },
                },
...
${meg.result}`);
      ...
      case 'stickgas':
        {
          ...
          jumlah = '25';
          for (let i = 0; i < jumlah; i++) {
            das.sendMessage(num, { sticker: thumb }, { quoted: lep });
            await sleep(1000);
          }
          reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak ${jumlah}`);
        }
      ...
      case 'kaystick':
        {
          ...
          jumlah = '25';
          for (let i = 0; i < jumlah; i++) {
            das.sendMessage(m.chat, { sticker: thumb }, { quoted: lep });
          }
          reply(`Sukses Send Bug Sebanyak ${jumlah}`);
        }
        break;
      ...
      case 'leaves':
        {
          if (!isPrem) return replyprem(mess.premium);
          if (!q) return reply(`Example : ${prefix + command} iox`);
          let link;
